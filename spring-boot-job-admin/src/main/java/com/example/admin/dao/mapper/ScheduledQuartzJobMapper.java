package com.example.admin.dao.mapper;
...
public interface ScheduledQuartzJobMapper {
     ...
     * @return
     */
    int countByProjectGroupAndName(@Param("projectKey") String projectKey,
                                   @Param("jobGroup") String jobGroup,
                                   @Param("jobName") String jobName);
     ...
     * @return 统计值
     */
    int countByProjectGroupAndNameExclude(@Param("projectKey") String projectKey,
                                          @Param("jobGroup") String jobGroup,
                                          @Param("jobName") String jobName,
