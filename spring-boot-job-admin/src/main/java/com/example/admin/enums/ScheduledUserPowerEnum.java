...
public enum ScheduledUserPowerEnum {
    ...
    /* 默认权限  */
    DEFAULT("DEFAULT", "/index,/home,/user-person,/job/getHomeCount,/user/getUserPersonDetail"),
     ...
     * 修改人员
     */
    USER_UPDATE("userUpdate", "/user/update,/user-detail,/user/getUserDetail"),

    /**
     * 修改人员密码
     */
    USER_UPDATE_PWD("userUpdatePwd", "/user-edit-pwd,/user/update-pwd"),

    /**
     * 修改人员权限
     */
    USER_UPDATE_POWER("userUpdatePower", "/user-edit-power,/user/getUserDetail,/user/update-power"),
     ...
     * 任务管理列表
     */
    TASK_MANGER("taskManger", "/task-list,/job/listPage"),

    /**
     * 添加任务
     */
    TASK_ADD("taskAdd", "/task-add,/job/save"),

    /**
     * 修改任务
     */
    TASK_UPDATE("taskUpdate", "/task-detail,/job/getJobDetail,/job/update"),
     ...
     * 日志管理列表
     */
    TASK_LOG_MANGER("taskLogManger", "/task-log-list,/task-log-detail,/job-log/listPage,/job-log/getLogDetail"),
