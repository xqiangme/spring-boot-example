...
import com.example.admin.enums.ScheduledDelFlagEnum;
...
@Slf4j
@Service
public class ScheduledQuartUserServiceImpl implements ScheduledQuartUserService {
    ...
    public UserInfoPageVO listPage(JobTaskUserPageQueryBO queryBO) {
        ...
        JobUserPageQueryDTO pageQueryDTO = JobUserPageQueryDTO.builder()
                ...
                .adminFlag(queryBO.getAdminFlag())
        ...
        UserInfoDetailVO detailVO = null;
        List<UserInfoDetailVO> resultList = new ArrayList<>(userList.size());
        for (ScheduledQuartUserInfo userInfo : userList) {
            detailVO = BeanCopierUtil.copy(userInfo, UserInfoDetailVO.class);
        ...
        return new UserInfoPageVO(total, resultList);
    }
    ...
    public UserInfoDetailVO getUserPersonDetail() {
        ...
        userInfoDetail.setCreateTimeStr(DateUtil.formatDateTime(userInfo.getCreateTime()));
    ...
    public void saveUser(JobTaskUserSaveBO saveParam) {
        ...
        try {
            ...
            userInfo.setAdminFlag(saveParam.getAdminFlag());
    ...
    public void updateUser(JobTaskUserUpdateBO updateBO) {
        String project = basicJobConfig.getProject();
